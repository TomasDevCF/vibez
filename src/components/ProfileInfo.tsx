...
export default function ProfileInfo({ userInfo }: Props) {
  ...
  return (
    <div className="profile-info pt-5">
      <p className="text-sm rubik font-medium text-white">{userInfo.name}</p>
      <p className="text-sm rubik text-gray-400">@{userInfo.username}</p>
      ...
      <p className="text-white text-xs pt-2 font-light text-wrap flex gap-1">
